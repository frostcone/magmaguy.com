...
# Définit la valeur de ce matériau pour le système de devises elitemobs.
  ...
  # Définit la valeur de ce matériau pour le système de devises elitemobs.
  WOODEN_PICKAXE: 13.0
  # Définit le valeur de ce matériau pour le sistema de moneda de elitemobs
  TRIDENT: 17.0
  # Définit la valeur de ce matériau pour le système de moneda de elitemobs
  ELYTRA: 17.0
  # Définit le valeur de ce matériau pour le système de moneda de elitemobs
  TURTLE_HELMET: 13.0
  # Définit la valeur de ce matériau pour le système de devises elitemobs.
  NETHERITE_AXE: 18.0
  # Définit la valeur de ce matériau pour le système de devises elitemobs.
  ...
  # Définit la valeur de matériau par défaut pour les objets qui ne sont pas définis spécifiquement.
...
`ProceduralItemGenerationSettings.yml` contient tous les paramètres de configuration pour la configuration des objets générés de façon procédurale.
