EliteMobs uses DiscordSRV to enable the broadcast of level 3 priority messages. You can read about the Announcement Priority System [here]($language$/elitemobs/announcement_priority_system.md).
