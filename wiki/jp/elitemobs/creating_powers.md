...
adventurersGuildNotificationMessages: '&7[EM] Dépense supplémentaire ? Essayez &a/ag !'
...
Economy money from payment message: Vous avez reçu &2$amount_received $currency_name
  &ffrom $sender
# Message envoyé lorsque les joueurs tentent d'envoyer un montant de pièces qu'ils ne possèdent pas.
...
Tax confirmation message: '&cL'envoi d'un paiement coûtera $percentage % en taxes. &aFaire
...
# Message envoyé lorsque les joueurs n'ont pas suffisamment de devises pour acheter un objet
...
Shop sale instructions: '&cVous ne pouvez vendre que du butin EliteMobs ici ! (Armure/armes
  laissées tomber par les élites montrant une valeur dans leur histoire)'
