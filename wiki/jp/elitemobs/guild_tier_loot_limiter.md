...
ギルドティアのルート制限は、プレイヤーが自分のギルドティアに基づいて獲得できる最高のルートを制限します。

プレイヤーは、冒険者ギルドのハブに行き、ギルド受付係のジリアンNPCと話すか、*/em rank* コマンドを実行することで、より高いティアをアンロックできます。ランクはエリートコインで購入することでアンロックされます。

デフォルト設定を使用している場合、プレイヤーは以下の方法で制限されます。
...
この時点から、ギルドティアをアンロックするにはプレステージレベルが必要になります。
...
## 仕組みとエッジケース
ギルドティアはプレイヤーが倒せるアイテムのティアを制限するため、モブのレベルはプレイヤーが装備しているギアに基づいていることから、プレイヤーは特定のレベルまでのモブしかスポーンさせられないことを意味します。プレイヤーがより高レベルのフレンドと一緒にモブを狩りに行った場合、彼らが獲得するルートはフレンドのものよりも低レベルになります。

[ソウルバインド](ja/elitemobs/soulbind.md)エンチャントと組み合わせることで、パワーレベリングの問題をかなり抑制し、管理者はサーバーに参加して数分で最大ティアに到達する訪問者や、新規プレイヤーがすぐに大量のダイヤモンドティアアイテムを入手する心配をする必要がなくなります。さらに、ルートが自分だけのものであると感じられるため、プレイヤーは自分のルートとのより深い繋がりを持つことができます。
```