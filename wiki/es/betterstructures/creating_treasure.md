...
Los archivos de tesoro son los que determinan las tablas de botín para los cofres de BetterStructures. Por lo general, se asignan a los [generadores]($language$/betterstructures/creating_generators.md&section=treasurefilename), pero también se pueden establecer en el nivel de una [configuración de construcción individual]($language$/betterstructures/creating_structures.md&section=treasurefile).
...
Establece la `media`. Lea los detalles sobre eso [aquí](https://magmaguy.com/wiki.html#lang=es&article=betterstructures+creating_treasure.md&section=what-is-a-treasure-file?).
...
Establece la `desviación estándar`. Lea los detalles sobre eso [aquí](https://magmaguy.com/wiki.html#lang=es&article=betterstructures+creating_treasure.md&section=what-is-a-treasure-file?).
...
Establece si el elemento debe generarse procedimentalmente según la configuración si `procedurallyGeneratedItemSettings`. Tenga en cuenta que, según la configuración, esto podría resultar en la generación de un elemento sin encantamientos.
